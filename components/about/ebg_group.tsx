      ...
      <div className="max-w-[1440px] mx-auto flex justify-between items-center gap-10 max-lg:flex-col">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              <p className="text-muted font-helvetica text-xl leading-8 text-justify m-0">
                Carlton Wellness Salon is supported by EBG Group, a multi-brand platform operating
                across wellness, mobility, hospitality, realty, food, lifestyle, technology,
                services and social impact. With a strong foundation in brand building and business
                expansion, EBG creates interconnected ecosystems that combine operational structure,
                customer experience and scalable growth across multiple industries.
              </p>
              <p className="text-muted font-helvetica text-xl leading-8 text-justify m-0">
                Through franchise reach, sales capability, city partnerships and disciplined
                execution, EBG provides the infrastructure behind Carlton's long-term vision. This
                support enables Carlton Wellness Salon to evolve beyond individual locations into a
                refined, wellness-led salon platform designed for consistent luxury experiences,
                modern scalability and national presence.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-end gap-[15px] shrink-0 max-lg:w-full max-lg:justify-center">
          <div className="w-[257px] flex flex-col gap-6">
            <Image src={ebg1} alt="EBG 1" width={257} height={321} className="object-cover" />
            <div className="h-px bg-gold" />
          </div>
          <div className="w-[398px] flex flex-col gap-6">
            <div className="h-px bg-gold" />
            <Image src={ebg2} alt="EBG 2" width={398} height={510} className="object-cover" />
          </div>
        </div>
